...
export default function MenuItem(props) {
  ...
  return (
        <tr className="">
            <td>{props.name}</td>
            <td>${props.price}</td>
            <td className="btn" onClick={()=>props.cartProduct(props.id)}>
              <svg xmlns="http://www.w3.org/2000/svg" fill={props.carted>0?"black":"none"} viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
